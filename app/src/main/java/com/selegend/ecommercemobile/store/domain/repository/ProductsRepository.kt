...
interface ProductsRepository {
    suspend fun getProducts(name: String, categoryId: String, page: Int, limit: Int, sortBy: String, order: String): Either<NetworkError, Response<MetadataProducts>>
    suspend fun searchProduct(name: String, page: Int, limit: Int, sortBy: String, order: String): Either<NetworkError, Response<MetadataProducts>>
